...
<body class="bg-gray-100 p-4">
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold">Crear Apartamento</h2>
        ...
        <form method="POST" action="{{ route('apartamento.store') }}" enctype="multipart/form-data" class="space-y-4">
            @csrf

            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label for="numero_apartamento" class="block text-sm font-medium text-gray-700 mb-1">Número de apartamento:</label>
                    <input type="text" id="numero_apartamento" name="numero_apartamento" value="{{ old('numero_apartamento') }}"
                ...
                <div>
                    ...
                    <input type="number" id="tamaño" name="tamaño" value="{{ old('tamaño') }}" step="0.01"
                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                </div>
            ...
            <div class="flex justify-end mt-6">
                <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition">Crear Apartamento</button>
            </div>
        </form>
    </div>
</body>
