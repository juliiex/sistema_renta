    ...
    <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow">
        ...
        <form action="{{ route('usuarios.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nombre" value="{{ old('nombre') }}" class="w-full p-2 border rounded" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="telefono" value="{{ old('telefono') }}" class="w-full p-2 border rounded" required>
            </div>
                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <div class="flex items-center">
                        <input type="checkbox" name="roles[]" value="{{ $rol->id }}" id="rol_{{ $rol->id }}"
                            {{ old('roles') && in_array($rol->id, old('roles')) ? 'checked' : '' }}
